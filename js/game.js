class Game{
    ...
    move(){ // in just one step you synchronize every movement from all the elements through the frame nº
    ...
    draw(){
        ...
        this.background.draw(this.frameNumber); // we pass the frames even if we don't plan on using them so we have a universal time for everything
